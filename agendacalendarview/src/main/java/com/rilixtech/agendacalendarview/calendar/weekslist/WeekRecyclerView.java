...
public class WeekRecyclerView extends RecyclerView {
  ...
  private List<CalendarScrolledListener> listeners = new ArrayList<>();

  public interface CalendarScrolledListener {
    void onWeekRecyclerViewCalendarScrolled();
  }
  ...
  public WeekRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
  }

  public void addCalendarScrolledListener(CalendarScrolledListener listener) {
      ...
      switch (newState) {
        case SCROLL_STATE_IDLE:
          if (mUserScrolling) {
            ...
            // Wait for recyclerView to settle
  ...
  private void scrollToView(View child) {
    ...
    if (scrollDistance != 0) smoothScrollBy(0, scrollDistance);
  }
