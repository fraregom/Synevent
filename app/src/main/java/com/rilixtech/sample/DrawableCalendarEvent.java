...
public class DrawableCalendarEvent extends BaseCalendarEvent {
  ...
  @Override protected BaseCalendarEvent createObj() {
    return new DrawableCalendarEvent(this);
  }

  public static DrawableCalendarEvent prepareWith() {
  ...
  public DrawableCalendarEvent drawableId(int drawableId) {
    this.mDrawableId = drawableId;
    return this;
  }

  @Override public DrawableCalendarEvent copy() {
    return new DrawableCalendarEvent(this);
  }
