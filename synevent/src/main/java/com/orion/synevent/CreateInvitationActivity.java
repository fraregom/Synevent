...
public class CreateInvitationActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        btn_save = findViewById(R.id.btn_create_invitation);
        btn_cancel = findViewById(R.id.btn_cancel_invitation_create);
    ...
    public void onDateSet(com.wdullaer.materialdatetimepicker.date.DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        ...
        TimePickerDialog timepickerdialog = TimePickerDialog.newInstance(CreateInvitationActivity.this,
        ...
        timepickerdialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialogInterface) {
                Toast.makeText(CreateInvitationActivity.this, "Cancel choosing time", Toast.LENGTH_SHORT).show();
            }
        });
